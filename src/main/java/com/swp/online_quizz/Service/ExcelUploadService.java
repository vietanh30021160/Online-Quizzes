...
public class ExcelUploadService {
    ...
    public Quiz createQuizFromExcel(MultipartFile excelFile, User teacher) throws IOException {
        try {
            ...
            String timeLimitString = quizSheet.getRow(1).getCell(2).getStringCellValue(); // Lấy giá trị của ô trong
                                                                                          // bảng
            ...
            if (timeLimitColonIndex != -1) {
                ...
                try {
                    ...
                    throw new NullPointerException("File excel not follow template");
                }
            }
